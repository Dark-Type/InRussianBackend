...
fun Route.mailingRoutes(
    mailer: Mailer,
    recoveryRepo: EmailTokenRepository,
    userRepo: UsersRepository,
    ttlMinutes: Long = 10
) {
    post<PasswordRecoveryResource.Request> {
    ...
    post<PasswordRecoveryResource.Check> {
    ...
    post<PasswordRecoveryResource.Reset> {
    ...
    post<EmailVerificationResource.Verify> {
    ...
    post<EmailVerificationResource.Resend> {
...
private fun getPasswordRecoveryEmailContent(
    code: String,
    ttlMinutes: Long,
